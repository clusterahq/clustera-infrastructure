...
from .integrations import create_kafka_resources
# from .integrations import create_pubsub_resources  # GCP Pub/Sub disabled
...
__all__ = [
    ...
    # "create_pubsub_resources",  # GCP Pub/Sub disabled
